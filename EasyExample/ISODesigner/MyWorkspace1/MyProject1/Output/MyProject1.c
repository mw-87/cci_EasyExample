...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(WorkingSet_0), TYPEID_WORKSET, COLOR(187), 1, ID(DataMask_Home), 1, 0, 2,
		...
		'e', 'n',
		'd', 'e',
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 14, 0, 
		XYREF(Button_PlusPlus, 360, 400),
		XYREF(Container_Gesamtzaehler, 10, 10),
		XYREF(Container_Tageszaehler, 10, 98),
		XYREF(LinearBargraph_Tageszaehler, 380, 180),
		XYREF(Button_Minus, 250, 400),
		XYREF(InputNumber_Tagesziel, 50, 420),
		XYREF(Meter_Gesamtzaehler, 10, 240),
		XYREF(Meter_Tageszaehler, 10, 240),
		XYREF(LinearBargraph_Gesamtzaehler, 310, 180),
		XYREF(InputNumber_Gesamtziel, 50, 190),
		XYREF(ObjectPointer_Gesamtziel_erreicht, 120, 323),
		XYREF(ObjectPointer_Tagesziel_erreicht, 119, 310),
		XYREF(OutputString_Tagesziel_erreicht, 556, 74),
		XYREF(OutputString_Gesamtziel_erreicht, 552, 342),
	...
	ID(SoftKey_PlusPlus), TYPEID_SOFTKEY, COLOR(187), 1, 1, 0, 
		XYREF(OutputString_PlusPlus, 9, 24),
	...
	ID(SoftKey_Minus), TYPEID_SOFTKEY, COLOR(254), 1, 1, 0, 
		XYREF(OutputString_11007, 0, 25),
	ID(Button_Minus), TYPEID_BUTTON, WORD(90), WORD(50), 249, 249, 1, 0, 1, 0, 
	...
	ID(Button_PlusPlus), TYPEID_BUTTON, WORD(90), WORD(50), 187, 144, 1, 0, 1, 0, 
		XYREF(OutputString_PlusPlus, 9, 9),
	ID(InputNumber_Tagesziel), TYPEID_INNUM, WORD(140), WORD(40), COLOR_WHITE, ID(FontAttributes_Default), 0, 
		ID(NumberVariable_Tagesziel), LONG(123UL), LONG(0UL), LONG(65535UL), LONG(0L), FLOAT_1, 0, 0, 1, 1, 0, 
	ID(InputNumber_Gesamtziel), TYPEID_INNUM, WORD(140), WORD(40), COLOR_WHITE, ID(FontAttributes_Default), 0, 
		ID(NumberVariable_Gesamtziel), LONG(0UL), LONG(0UL), LONG(65535UL), LONG(0L), FLOAT_1, 0, 0, 1, 1, 0, 
	ID(OutputString_PlusPlus), TYPEID_OUTSTR, WORD(64), WORD(29), COLOR_WHITE, ID(FontAttributes_Default), 1,
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(80), WORD(40), COLOR_WHITE, ID(FontAttributes_Button), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_11006), TYPEID_OUTSTR, WORD(81), WORD(20), COLOR_WHITE, ID(FontAttributes_Default), 1,
		ID(ID_NULL), 1, WORD(4), '-', '-', ' ', ' ', 0,
	ID(OutputString_11007), TYPEID_OUTSTR, WORD(80), WORD(50), COLOR_WHITE, ID(FontAttributes_Default), 1,
		ID(ID_NULL), 1, WORD(4), '-', '-', ' ', ' ', 0,
	ID(OutputString_Tagesziel_erreicht), TYPEID_OUTSTR, WORD(300), WORD(70), COLOR_WHITE, ID(FontAttributes_Default), 2,
		ID(ID_NULL), 1, WORD(19), 'T', 'a', 'g', 'e', 's', 'z', 'i', 'e', 'l', '\r', '\n',
		'e', 'r', 'r', 'e', 'i', 'c', 'h', 't', 0,
	ID(OutputString_Gesamtziel_erreicht), TYPEID_OUTSTR, WORD(300), WORD(70), COLOR_WHITE, ID(FontAttributes_Default), 2,
		ID(ID_NULL), 1, WORD(20), 'G', 'e', 's', 'a', 'm', 't', 'z', 'i', 'e', 'l', '\r', '\n',
		'e', 'r', 'r', 'e', 'i', 'c', 'h', 't', 0,
	...
	ID(ObjectPointer_Gesamtziel_erreicht), TYPEID_OBJPTR, ID(ID_NULL), 
	ID(ObjectPointer_Tagesziel_erreicht), TYPEID_OBJPTR, ID(ID_NULL), 
